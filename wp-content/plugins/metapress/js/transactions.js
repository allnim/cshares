class MetaPress_Plugin_User_Transactions_Loader {
    ...
    request_transactions() {
        if( metapress_metamask_loading_manager.currentMMAccount ) {
            ...
            metapress_transactions_request_url = this.set_request_param(metapress_transactions_request_url, 'mpwalletaddress', metapress_metamask_loading_manager.currentMMAccount);
            metapress_transactions_request_url = this.set_request_param(metapress_transactions_request_url, 'request_key', metapressjsdata.request_key);
            jQuery.ajax({
